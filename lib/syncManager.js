...
export async function triggerJiitSync(credentials, uid) {
    ...
    try {
        ...
        const [subjects, attendanceOverview] = await Promise.all([
        ...
        // Attendance overview already has percentages - no need to fetch daily details
        // LTpercantage = combined, Lpercentage = lab, Tpercentage = theory
