...
export const Portal = {
    ...
    getPersonalInfo: () => engine.getPersonalInfo(),
    getSubjectDailyAttendance: (semester, subjectId, subjectCode, componentIds) => engine.getSubjectDailyAttendance(semester, subjectId, subjectCode, componentIds),
};